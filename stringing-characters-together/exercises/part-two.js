...
//console.log(dna.trim()); original answer, but check work answer set a new variable so i guess i will too
let dnaNoSpace = dna.trim();
...
if (dnaTwo.indexOf('CAT') != -1){
    ...
    console.log("CAT index = " + dnaTwo.indexOf('CAT'));
} else {
